...
export default function NavBar() {
  ...
  return (
    <>
      ...
      <motion.nav
        className="flex items-center justify-between gap-4 border-b   border-[#ffffff93] px-2 md:px-20 py-3  md:flex-row text-white   bg-[#e2e8f00a]  backdrop-blur-sm mx-auto // sticky top-0 z-20 inset-x-0"
        variants={{
          hidden: {
            y: -100,
          },
