  ...
  return (
    <>
      <section className="text-white py-24 md:py-32  ">
        <div className="w-[92%] md:w-10/12 lg:w-2/3 2xl:w-2/4 mx-auto rounded-xl  relative h-48  md:h-52 xl:h-56 bg-cover bg-no-repeat bg-center bg-[url('/assets/camera.jpg')] shadow-sm shadow-black">
