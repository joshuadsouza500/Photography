...
export default async function Services() {
  ...
  return (
    <section className="mx-2 md:px-6 lg:px-20  py-16 xl:py-20  text-white">
      {" "}
      <div className="lg:mx-auto max-w-xxxl">
        <div className=" mx-auto max-md:w-[95%] mb-12 md:mb-1 xl:pb-10">
          <HeadingLine />
          <Motionh1
